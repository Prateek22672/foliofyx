...
export default function SectionWhite({ handleNavigation, scrollProgress }) {
  ...
  // Measure the width of the horizontal track
  ...
  return (
    <>
      <Cursor />
      <section className="relative h-screen bg-white text-black rounded-t-[40px] md:rounded-t-[60px] shadow-[0_-50px_100px_rgba(0,0,0,0.1)] overflow-hidden font-['Switzer'] will-change-transform">
          ...
          <div className="pl-6 md:pl-16 pt-2 overflow-hidden h-[65vh] flex items-center">
            ...
            >
              ...
              <motion.div 
                ...
                className="w-[85vw] sm:w-[280px] md:w-[290px] h-[55vh] md:h-[60vh] bg-[#111] text-white rounded-[30px] md:rounded-[40px] p-6 md:p-8 shrink-0 flex flex-col justify-center shadow-lg hover:shadow-xl transition-shadow duration-300"
              >
              ...
              {CARDS.map((card) => (
                <motion.div
                  ...
                  transition={{ type: "spring", stiffness: 300, damping: 30 }}
                  // HEIGHT: 55vh Mobile / 60vh Desktop
                  className={`w-[85vw] sm:w-[280px] md:w-[290px] h-[55vh] md:h-[60vh] ${card.bg} ${card.text}
                ...
                >
                  ...
                  <img
                    src={card.img}
                    alt={card.altText} // Uses the detailed keyword-rich description
                    title={card.altText} // Tooltip text on hover
                    loading="lazy"
                    width="400" // Helps prevent layout shift (CLS)
                    height="600"
                  ...
                  <div className="relative z-10 p-6 md:p-8 flex flex-col justify-between h-full">
                    ...
                    <div>
                      ...
                      {/* Description acts as caption context for SEO */}
