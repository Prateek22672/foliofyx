      ...
      {showContent && (
        <motion.div initial={{ opacity: 0, y: 30 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.9 }} className="relative z-20 w-full h-full flex flex-col items-center justify-center px-6">
          <div className="flex flex-col items-center justify-center w-full max-w-5xl -mt-12 sm:mt-0">
            ...
            {/* New AI Chat Builder highlight — mt clears the fixed header pill */}
            <motion.button
              initial={{ opacity: 0, y: -8 }}
              animate={{ opacity: 1, y: 0 }}
              transition={{ delay: 0.6, duration: 0.7 }}
              onClick={() => handleNavigation("/ai-builder", "Opening AI Builder...")}
              className={`group mt-24 sm:mt-20 flex items-center gap-2 rounded-full border px-4 py-1.5 text-[10px] sm:text-[11px] font-bold uppercase tracking-[0.18em] transition-colors ${
                isDarkBg
