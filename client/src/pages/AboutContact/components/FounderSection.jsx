            ...
            <div className="flex flex-col md:flex-row items-end justify-between gap-8 border-t border-white/10 pt-8">
                ...
                <div className="flex items-center gap-6 w-full md:w-auto justify-between md:justify-end">
                    ...
                    >
                        ...
                        <a
                            href="https://www.linkedin.com/company/foliofyx"
                            target="_blank"
                            rel="noreferrer"
                            aria-label="FolioFYX on LinkedIn"
                    ...
                    <motion.div
                        ...
                        className="hidden md:flex items-center px-4 py-2 rounded-2xl border border-white/10 opacity-60 hover:opacity-100 transition-opacity duration-500"
                    >
                         <img src="/logow.png" alt="FolioFYX" className="h-6 w-auto object-contain" />
                    </motion.div>
                </div>
            </div>
        </div>
