      ...
      <div className="max-w-7xl mx-auto w-full grid lg:grid-cols-2 gap-16 items-center">
        ...
        >
          ...
          >
            <span style={{ color: fg }}>
              <EditableText
                value={data.role || "Digital Creator"}
                onChange={(val) => setPortfolioData({ ...data, role: val })}
                readOnly={isReadOnly}
              />
            </span>
            <span className="w-1 h-1 rounded-full" style={{ backgroundColor: fg, opacity: 0.3 }}></span>
            <span className="flex items-center gap-1" style={{ color: fg, opacity: 0.6 }}>
              <MapPin size={10} />
              <EditableText
                value={data.location || "India"}
          ...
          <h1 className="text-6xl md:text-8xl lg:text-9xl font-medium leading-[0.9] tracking-tighter mb-8">
            ...
            <span className="block" style={{ color: fg, opacity: 0.3 }}>
              <EditableText
                value={firstName}
          ...
          >
            <EditableText
              value={data.caption || "Crafting digital experiences with precision, blending technical expertise with modern aesthetics."}
        ...
        >
          <div
            className="relative w-full max-w-[400px] aspect-[3/4] rounded-[2rem] overflow-hidden shadow-2xl border"
          ...
          >
            ...
            <motion.div
              ...
              className="absolute bottom-6 left-6 right-6 p-5 rounded-2xl bg-white/10 backdrop-blur-md border border-white/20 shadow-lg pointer-events-none"
            >
              <div className="flex items-center gap-5">
                ...
                <div className="flex flex-col min-w-0">
                  ...
                  <p className="text-white font-bold text-lg leading-none truncate">
                    {text}<span className="animate-pulse ml-1 text-blue-400">|</span>
                  </p>
                </div>
              </div>
            </motion.div>
