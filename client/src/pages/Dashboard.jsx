      ...
      <div className="relative z-10 px-4 sm:px-10 pb-20">
        ...
        <div className="flex flex-col md:flex-row items-center justify-between mb-12 gap-6 max-w-7xl mx-auto">
          <div className="text-center md:text-left">
            <h1 className="text-4xl md:text-5xl font-bold text-black tracking-tight flex items-center gap-3 justify-center md:justify-start flex-wrap">
              My Portfolios

              <span
                id="plan-badge"
                className={`text-[10px] md:text-xs align-middle px-3 py-1 rounded-full uppercase tracking-wider border font-bold
                  ${userPlan === "max"
              ...
              <button
                ...
                title="Show page tutorial"
                className="w-7 h-7 rounded-full bg-gray-100 hover:bg-gray-200 text-gray-500 hover:text-gray-800 text-[13px] font-bold transition-all flex items-center justify-center flex-shrink-0"
              >
                ?
              </button>
            </h1>
            <p className="text-neutral-500 mt-2 text-lg">Manage your digital presence.</p>
          </div>
          ...
          <button
            ...
            className={`
              ...
              px-8 py-3.5 rounded-full font-medium text-base
        ...
        {portfolios.length === 0 ? (
          <div className="flex flex-col items-center justify-center py-32 border-2 border-dashed border-neutral-200 rounded-[2.5rem] bg-neutral-50/50 max-w-7xl mx-auto">
            ...
            {/* ✅ Clickable + circle — navigates to /create */}
            <motion.button
              onClick={handleCreateClick}
